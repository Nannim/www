...
if (empty($projectContents))
	...
	if(strpos($projectContents,"http://localhost/") !== false) {
		$projectContents .= "<li><i style='color:blue;'>Happy Coding From</i> Nannim</li>";
		if(!isset($error_content))
			$error_content = '';
		$error_content .= "<p style='color:blue;'>Did You Know? The Web Is One Of The Largest Places On Earth?</p>";
	}
}
